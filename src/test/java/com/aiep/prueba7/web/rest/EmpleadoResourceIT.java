...
import static com.aiep.prueba7.domain.EmpleadoAsserts.*;
import static com.aiep.prueba7.web.rest.TestUtil.createUpdateProxyForBean;
...
class EmpleadoResourceIT {
    ...
    void partialUpdateEmpleadoWithPatch() throws Exception {
        ...
        partialUpdatedEmpleado.apellidoEmpleado(UPDATED_APELLIDO_EMPLEADO).telefonoEmpleado(UPDATED_TELEFONO_EMPLEADO);
